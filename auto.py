...
def sent_report(cookies):
    ...
    params = {
        ...
        "city":"三明市",
        "province":"福建省",
        "address":"福建省三明市大田县济阳乡001乡道",
        "geo_api_info":'{"type":"complete","info":"SUCCESS","status":1,"$Da":"jsonp_687452_","message":"Get ipLocation success.Get address success.","location_type":"ip","accuracy":null,"isConverted":true,"addressComponent":{"citycode":"0598","adcode":"350425","businessAreas":[],"neighborhoodType":"","neighborhood":"","building":"","buildingType":"","street":"","streetNumber":"","country":"中国","province":"福建省","city":"三明市","district":"大田县","towncode":"350425203000","township":"济阳乡"},"formattedAddress":"福建省三明市大田县济阳乡001乡道","roads":[],"crosses":[],"pois":[]}',   #高德SDK返回值
        "sfcyglq":"0",  #是否隔离期
        "sfyzz":"0",    #是否有症状
        "qtqk":"",  #其他情况
        "ymtys":""  #不明（可能是一码通颜色，暂无用）
